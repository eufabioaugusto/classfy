  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      try {
        ...
        const pointsToNextLevel = Math.ceil(
          pointsNeededForNext - pointsInCurrentLevel,
        );
        ...
        if (cycle) {
          const { data: userCycle } = await supabase
            ...
            .select("cycle_points, user_points, creator_points")
    ...
    ? [
        {
          Icon: Video,
          label: "Publicações",
          value: stats.creatorStats.totalContents.toLocaleString("pt-BR"),
        },
        {
          Icon: Eye,
          label: "Visualizações",
          value: stats.creatorStats.totalViews.toLocaleString("pt-BR"),
        },
        {
          Icon: Heart,
          label: "Curtidas recebidas",
          value: stats.creatorStats.totalLikes.toLocaleString("pt-BR"),
        },
        {
          Icon: BarChart3,
          label: "Engajamento médio",
          value: `${stats.creatorStats.avgEngagement.toFixed(1)}%`,
        },
      ]
    : [];
    ...
    >
      ...
      >
            ...
            <div className="economy-balance-hero__top">
              ...
              <h2 className="economy-balance-hero__headline">
                {isCreator
                  ...
                  : "Combine ações de estudo para evoluir sua participação."}
              </h2>
              <span className="economy-balance-hero__label">
                {isCreator
                  ? "Pontuação total do ciclo"
                  : "Points acumulados neste ciclo"}
              </span>
              ...
              {isCreator ? (
                <div
                  className="economy-balance-breakdown"
                  aria-label="Composição da pontuação total do ciclo"
                >
                  <span>
                    <strong>
                      {stats.cycleUserPoints.toLocaleString("pt-BR")}
                    </strong>
                    Points de estudo e participação
                  </span>
                  <span>
                    <strong>
                      {stats.cycleCreatorPoints.toLocaleString("pt-BR")}
                    </strong>
                    Creator Points
                  </span>
                </div>
                ...
                <div className="economy-balance-hero__meta">
                  <span>
                    <span className="economy-status-dot" />
                    Somando Points agora
                  </span>
                </div>
              )}
              <div className="economy-balance-hero__meta">
            ...
            <div id="nivel" className="economy-balance-hero__bottom economy-level">
              <div className="economy-level__row">
                <div>
                  ...
                  <span className="economy-level__value">
                    {stats.totalPoints.toLocaleString("pt-BR")} Points
                    acumulados
                  </span>
                </div>
              ...
              <div
                ...
                aria-label={`${stats.progressPercent.toFixed(0)}% do nível concluído`}
              >
                <span
        ...
        <section
          ...
          aria-labelledby="reward-overview-title"
        >
          <V2SectionHeader
          ...
          <div className="economy-metric-grid">
            {[
              {
                Icon: Zap,
                label: "Points acumulados",
                value: stats.totalPoints.toLocaleString("pt-BR"),
                detail: "Somados desde a sua entrada",
              },
              {
                Icon: Wallet,
                label: "Saldo disponível",
                value: formatMoney(stats.balance),
                detail: `${formatMoney(stats.totalEarned)} gerados no total`,
              },
              {
                Icon: Flame,
                label: "Acessos consecutivos",
                value: `${stats.currentStreak} dias`,
                detail: `Seu recorde é de ${stats.longestStreak} dias`,
              },
              {
                Icon: Target,
        ...
        <section className="economy-section">
          ...
          <div className="economy-content-grid">
                ...
                <div className="economy-panel-heading">
                  ...
                  <div>
                    ...
                    <p className="economy-panel-copy">
                      {unlockedMilestones.length} desbloqueadas de{" "}
                      {milestones.length}
                    </p>
                  </div>
                </div>
                    ...
                    <TabsContent value="unlocked" className="mt-5">
                      {unlockedMilestones.length ? (
                        ...
                        <div className="py-10 text-center">
                          <p className="economy-panel-title">
                            Sua primeira conquista está próxima
                          </p>
                          <p className="economy-panel-copy">
                            Complete metas para marcar o início da sua coleção.
                          </p>
                        </div>
                      )}
                    </TabsContent>
            ...
            <V2Card className="economy-panel">
              <V2CardHeader>
                <div className="economy-panel-heading">
                  <span className="economy-icon economy-icon--warning">
                    <Flame aria-hidden="true" />
                  </span>
                  <div>
                    <h2 className="economy-panel-title">
                      Bônus por acesso diário
                    </h2>
                    <p className="economy-panel-copy">
                      Entre na Classfy em dias consecutivos para liberar bônus.
                    </p>
                  </div>
                </div>
                <V2Badge className="economy-streak-badge" variant="warning">
              ...
              <V2CardContent>
                <div className="economy-stat-list">
                  ...
                  <div className="economy-stat-row">
                    <span className="economy-stat-row__label">
                      <Sparkles />
                      Bônus por 7 dias seguidos
                    </span>
                    <strong className="economy-stat-row__value">
                      faltam {nextStreakReward} dias
                    </strong>
                  </div>
                </div>
              </V2CardContent>
        ...
        <section className="economy-section">
          <V2SectionHeader
            eyebrow="Atividade"
            title={
              isCreator ? "Seu estudo e sua criação" : "Suas ações na Classfy"
            }
            description="Veja o que foi registrado na sua conta."
          />
          <div className="economy-content-grid">
            <V2Card className="economy-panel">
              <V2CardHeader>
              ...
              <V2Card className="economy-panel">
                <V2CardHeader>
                  <div className="economy-panel-heading">
                    ...
                    <div>
                      <h2 className="economy-panel-title">
                        Resultados dos seus conteúdos
                      </h2>
                      <p className="economy-panel-copy">
                        Dados dos conteúdos já aprovados
                      </p>
                    </div>
                  </div>
                </V2CardHeader>
        ...
        <section className="economy-section economy-content-grid">
            ...
            <V2Card className="economy-panel">
              <V2CardHeader>
                <div className="economy-panel-heading">
                  ...
                  <div>
                    <h2 className="economy-panel-title">Próxima conquista</h2>
                    <p className="economy-panel-copy">{nextMilestone.title}</p>
                  </div>
                </div>
              ...
              <V2CardContent>
                <strong className="economy-metric__value">
                  {nextMilestone.milestone_value.toLocaleString("pt-BR")}{" "}
                  {typeLabel[nextMilestone.milestone_type] || ""}
                </strong>
                <div className="economy-progress mt-6">
                  <span
                    style={{
                      width: `${Math.min(100, nextMilestone.percentComplete)}%`,
                    }}
                  />
                </div>
                <div className="economy-progress-copy">
                  <span>
                    {nextMilestone.currentValue.toLocaleString("pt-BR")} de{" "}
                    {nextMilestone.milestone_value.toLocaleString("pt-BR")}
                  </span>
                  <span>
                    {nextMilestone.percentComplete.toFixed(0)}% concluído
                  </span>
                </div>
              </V2CardContent>
            </V2Card>
          ...
          <V2Card className="economy-panel">
            <V2CardContent className="flex min-h-[13rem] flex-col items-start justify-center">
              ...
              <h2 className="economy-panel-title mt-3">
                Veja como seus Points foram ganhos.
              </h2>
              <p className="economy-panel-copy">
                Consulte cada ação, data, tipo de Point e conteúdo relacionado.
              </p>
              <V2Button
                variant="secondary"
                className="mt-6"
