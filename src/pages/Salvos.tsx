...
export default function Salvos() {
  ...
  const loadSaved = async () => {
    ...
    try {
      ...
      const contentsList = (savedData || [])
        .map((saved: any) => saved.contents)
  ...
  return (
    <AdminLayout title="Salvos">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            <Bookmark className="w-8 h-8 text-primary" fill="currentColor" />
            <h1 className="text-4xl font-bold text-foreground">Salvos</h1>
          </div>
          ...
          <div className="text-center py-20">
            <div className="flex flex-col items-center gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Salve conteúdos para assistir mais tarde
                </p>
              </div>
            </div>
          </div>
