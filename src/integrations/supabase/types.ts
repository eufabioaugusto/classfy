...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      wallet_transactions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "wallet_transactions_cycle_id_fkey"
            columns: ["cycle_id"]
            isOneToOne: false
            referencedRelation: "economic_cycles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "wallet_transactions_withdraw_request_id_fkey"
    ...
    Views: {
      v_wallet_ledger: {
        Row: {
          balance_from_ledger: number | null
          balance_stored: number | null
