...
function getDmTemplate(prospect: Prospect): string {
  ...
  const templates: Record<string, string> = {
    micro: `Olá! Acompanhamos o canal ${name} e acreditamos que vocês têm um enorme potencial para fazer parte do nosso time de Embaixadores Fundadores.\n\nEstamos lançando a Classfy — 40% da receita líquida elegível compõe um pool mensal distribuído por participação em Points. Quem entra agora participa das decisões iniciais.\n\nGostaria de receber mais detalhes?`,
    pequeno: `Olá! Acompanhamos o ${name}${niche} e temos uma pergunta: como sua plataforma remunera o movimento real gerado pelo seu conteúdo?\n\nNa Classfy, 40% da receita líquida elegível compõe um pool mensal distribuído por participação em Points. O ${name} tem perfil para ser um dos nossos Embaixadores Fundadores.\n\nPosso enviar mais detalhes?`,
    medio: `Olá! Reconhecemos a qualidade do conteúdo${niche} do ${name} e gostaríamos de fazer um convite.\n\nEstamos lançando a Classfy — 40% da receita líquida elegível compõe um pool mensal distribuído proporcionalmente aos Points válidos.\n\nAcreditamos que o ${name} tem grande potencial para ser um dos nossos Embaixadores Fundadores. Há interesse em saber mais?`,
    grande: `Olá! O ${name} tem o perfil exato que buscamos para nosso time de Embaixadores Fundadores.\n\nEstamos lançando a Classfy — 40% da receita líquida elegível compõe um pool mensal distribuído por participação em Points, com fórmula pública e transparente.\n\nPosso enviar mais detalhes sobre a proposta de parceria?`,
    bigplayer: `Olá! O ${name} tem um papel importante no que estamos construindo na Classfy.\n\n40% da receita líquida elegível compõe um pool mensal distribuído por participação em Points, com fórmula pública. Gostaríamos de convidar vocês para uma parceria como Embaixador Fundador.\n\nHá interesse em conhecer a proposta?`,
  };
              ...
              {previewProspect.outreach_channel !== "instagram" && (
                <div className="text-sm font-medium text-muted-foreground">
                  Assunto: <span className="text-foreground">{previewProspect.channel_name} — {
                    ...
                    previewProspect.size_tier === "grande" ? "Uma economia transparente para criadores" :
